...
import { type initialMessage, signUpAction } from "@/action/authAction";
                  ...
                  <FieldGroup>
                    ...
                    <Field>
                      ...
                      {state.error?.username && (
                        <FieldError>{state.error.username[0]}</FieldError>
                      )}
                    </Field>
                    ...
                    <Field>
                      ...
                      {state.error?.password && (
                        <FieldError>{state.error.password[0]}</FieldError>
                      )}
                    </Field>
